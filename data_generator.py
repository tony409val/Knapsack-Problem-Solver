...
# # EVALUATION DATA
# eval_data_uc_5 = generate_and_solve_instances('UC', 1000, 5, 1000, 100)
# eval_data_uc_10 = generate_and_solve_instances('UC', 1000, 10, 1000, 100)
# eval_data_uc_20 = generate_and_solve_instances('UC', 1000, 20, 1000, 100)
# eval_data_uc_50 = generate_and_solve_instances('UC', 100, 50, 1000, 100)
# eval_data_uc_100 = generate_and_solve_instances('UC', 100, 100, 1000, 100)
# eval_data_uc_200 = generate_and_solve_instances('UC', 100, 200, 1000, 100)

# eval_data_sc_5 = generate_and_solve_instances('SC', 1000, 5, 1000, 100)
# eval_data_sc_10 = generate_and_solve_instances('SC', 1000, 10, 1000, 100)
# eval_data_sc_20 = generate_and_solve_instances('SC', 1000, 20, 1000, 100)
# eval_data_sc_50 = generate_and_solve_instances('SC', 100, 50, 1000, 100)
# eval_data_sc_100 = generate_and_solve_instances('SC', 100, 100, 1000, 100)
# eval_data_sc_200 = generate_and_solve_instances('SC', 100, 200, 1000, 100)

# eval_data_ss_5 = generate_and_solve_instances('SS', 1000, 5, 1000, 100)
# eval_data_ss_10 = generate_and_solve_instances('SS', 1000, 10, 1000, 100)
# eval_data_ss_20 = generate_and_solve_instances('SS', 1000, 20, 1000, 100)
# eval_data_ss_50 = generate_and_solve_instances('SS', 100, 50, 1000, 100)
# eval_data_ss_100 = generate_and_solve_instances('SS', 100, 100, 1000, 100)
# eval_data_ss_200 = generate_and_solve_instances('SS', 100, 200, 1000, 100)
